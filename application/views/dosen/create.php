    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php echo form_open('dosen/save') ?>
            ...
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Semester</label> 
                <div class="col-8">
                <input id="smt" name="smt" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Hari</label> 
                <div class="col-8">
                <input id="hari" name="hari" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Ruangan</label> 
                <div class="col-8">
